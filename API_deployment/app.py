...
def handle_get_predict():
    return jsonify({"message": "Please send a POST request to this endpoint with the following JSON format data in the request body: {\"Living_Area\": int, \"Type_of_property\": \HOUSE\/ APPARTMENT, \"Number_of_rooms\": int, \"Locality\": int, \"Swimming_pool\": bool}"})
